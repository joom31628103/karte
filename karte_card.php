...
:root{--navy:#1a2a55;--navy2:#2c3e6b;--text:#1a1a2e;}
...
.big-name{font-size:14pt;font-weight:bold;letter-spacing:.05em;margin:2mm 0;}
.furigana{font-size:8pt;color:#555;}
...
<div class="tab-content active" id="tab0">
  ...
  <div class="two-col">
    <div>
      <table class="kt">
        <tr>
          <td class="lbl">学籍番号</td><td><span class="cell"><?= fv($s['student_id']) ?></span></td>
          <td class="lbl">出席番号</td><td><span class="cell"><?= fv($s['seat_number']) ?></span></td>
        </tr>
        <tr>
          <td class="lbl">クラス</td><td colspan="3"><span class="cell"><?= fv($s['class_name']) ?></span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3" style="font-size:13pt;font-weight:bold;padding:2.5mm 3mm;"><?= fv($s['name']) ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="lbl">保護者名</td><td colspan="3"><?= fv($s['parent_name']) ?></td>
        </tr>
        <tr>
          <td class="lbl">家庭電話</td><td colspan="3"><?= fv($s['phone']) ?></td>
        </tr>
        <tr>
          <td class="lbl">生徒携帯</td><td colspan="3"><?= fv($s['student_phone'] ?? '') ?></td>
        </tr>
        <tr>
          <td class="lbl">住　所</td><td colspan="3"><span class="cell" style="min-height:10mm"><?= fv($s['address']) ?></span></td>
        </tr>
        <tr>
          <td class="lbl">備　考</td><td colspan="3"><span class="cell" style="min-height:12mm;white-space:pre-wrap"><?= fv($s['notes']) ?></span></td>
        </tr>
      </table>
      <div class="stamp-row">
    ...
    <div>
      ...
      <table class="kt">
        ...
        <tr><td class="lbl"><?= $k ?></td><td><?= $v ?> 件</td></tr>
        <?php endforeach; ?>
      </table>
    </div>
  </div>
  ...
  <table class="rec">
    ...
    <tbody>
      ...
      <tr>
        <td class="dt"><?= fv($rec['record_date']) ?></td>
        <td class="ty"><?= fv($rec['record_type']) ?></td>
  ...
  <table class="rec">
    ...
    <tbody>
      ...
      <tr>
        <td class="dt"><?= fv($iv['interview_date']) ?></td>
        <td class="ty"><?= fv($iv['interview_type']) ?></td>
...
<div class="tab-content" id="tab1">
  ...
  <table class="kt" style="margin-bottom:4mm;">
    <tr>
      <td class="lbl" style="width:18mm;">クラス</td>
      <td style="width:40mm;"><?= fv($s['class_name']) ?></td>
      <td class="lbl" style="width:18mm;">出席番号</td>
      <td style="width:25mm;"><?= fv($s['seat_number']) ?></td>
      <td class="lbl" style="width:18mm;">性別</td>
      <td><?= fv($s['gender']) ?></td>
    </tr>
    <tr>
      <td class="lbl" rowspan="2">氏名</td>
      <td colspan="5" style="font-size:7.5pt;color:#555">ふりがな：<?= fv($s['furigana']) ?></td>
    </tr>
    <tr>
      <td colspan="5" style="font-size:15pt;font-weight:bold;padding:2mm 3mm;letter-spacing:.05em;"><?= fv($s['name']) ?></td>
    </tr>
    <tr>
      <td class="lbl">生年月日</td>
      <td colspan="5"><?= fv($s['birthday']) ?></td>
    </tr>
  </table>
  ...
  <div class="info-grid">
    ...
    <div class="info-box" style="grid-column:1/-1;">
      ...
      <div style="display:flex;gap:8mm;">
        <?php foreach($att as $k=>$v): ?>
        <div style="font-size:9pt;"><?= $k ?>：<strong><?= $v ?></strong> 件</div>
        <?php endforeach; ?>
      </div>
    </div>
    <div class="info-box" style="grid-column:1/-1;">
  ...
  <div style="margin-top:5mm;">
    <table class="kt">
      <tr>
        <th style="width:22%">記入日</th><th style="width:26%">担任署名</th>
        <th style="width:22%">保護者確認日</th><th style="width:30%">保護者署名</th>
      </tr>
...
<div class="tab-content" id="tab2">
  ...
  <div class="card-subtitle">
    <?= fv($s['class_name']) ?>　<?= fv($s['name']) ?>（<?= fv($s['furigana']) ?>）
    出力日：<?= date('Y年m月d日') ?>　担任：<?= $teacher ?> 先生
  </div>
